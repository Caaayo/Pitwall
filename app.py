...
from data.parser import load_ibt, get_laps, get_lap_time, get_corners, get_corner_summary
...
def update_charts(lap_a_value, lap_b_value):
    ...
    return speed_fig, input_fig, delta_fig, map_fig, corner_fig, best_lap, lap_a_time, lap_b_time, delta
